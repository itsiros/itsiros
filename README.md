...
**Aspiring backend engineer passionate about systems and networking.**
...
- Currently building my own **HTTP server** to understand the protocol at a fundamental level  
- Preparing for a full **Twitter clone**  
- Learning the foundations of **backend engineering & networking**  
...
![Hyprland](https://img.shields.io/badge/Hyprland-00A9E0?style=for-the-badge)
...
### 🔹 **HTTP Server Clone**
A beginners-to-intermediate project aiming to fully understand request parsing, sockets, networking, and server fundamentals.

### 🔹 **Upcoming: Twitter Clone**
Once the HTTP server is complete, moving on to building my own Twitter-like backend and frontend ecosystem.
...
-  Nvim fanboy  
-  Enjoy PC hardware & custom setups  
...
> I believe in incrementally mastering the fundamentals before stacking complexity.
